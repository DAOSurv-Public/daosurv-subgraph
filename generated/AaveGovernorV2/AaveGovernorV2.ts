...
export class AaveGovernorV2__getProposalByIdResultValue0Struct extends ethereum.Tuple {
  get id(): BigInt {
...
export class AaveGovernorV2__getVoteOnProposalResultValue0Struct extends ethereum.Tuple {
  get support(): boolean {
...
export class AaveGovernorV2 extends ethereum.SmartContract {
  static bind(address: Address): AaveGovernorV2 {
    return new AaveGovernorV2("AaveGovernorV2", address);
  }
  ...
  getProposalById(
    proposalId: BigInt
  ): AaveGovernorV2__getProposalByIdResultValue0Struct {
    let result = super.call(
      "getProposalById",
    ...
    return changetype<AaveGovernorV2__getProposalByIdResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getProposalById(
    proposalId: BigInt
  ): ethereum.CallResult<AaveGovernorV2__getProposalByIdResultValue0Struct> {
    let result = super.tryCall(
      "getProposalById",
      "getProposalById(uint256):((uint256,address,address,address[],uint256[],string[],bytes[],bool[],uint256,uint256,uint256,uint256,uint256,bool,bool,address,bytes32))",
      [ethereum.Value.fromUnsignedBigInt(proposalId)]
    ...
    return ethereum.CallResult.fromValue(
      changetype<AaveGovernorV2__getProposalByIdResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  getVoteOnProposal(
    proposalId: BigInt,
    voter: Address
  ): AaveGovernorV2__getVoteOnProposalResultValue0Struct {
    let result = super.call(
      "getVoteOnProposal",
    ...
    return changetype<AaveGovernorV2__getVoteOnProposalResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getVoteOnProposal(
    proposalId: BigInt,
    voter: Address
  ): ethereum.CallResult<AaveGovernorV2__getVoteOnProposalResultValue0Struct> {
    let result = super.tryCall(
      "getVoteOnProposal",
      "getVoteOnProposal(uint256,address):((bool,uint248))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<AaveGovernorV2__getVoteOnProposalResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
